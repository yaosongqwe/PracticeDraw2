...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        paint.setShader(new ComposeShader(new BitmapShader(b1, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP),
                new BitmapShader(b2, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP), PorterDuff.Mode.DST_IN));
    }
